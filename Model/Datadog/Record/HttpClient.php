...
namespace Evo8fx\M2ddlogger\Model\Datadog\Record;
 ...
 * Class Client
 *
 * @package Evo8fx\M2ddlogger\Model\Datadog\Record
 */
class HttpClient implements DatadogHttpInterface
{
    const CONFIG_DD_HTTP_REGION = 'm2ddlogger/datadog/http_endpoint/account_region';
    const CONFIG_DD_HTTP_API_KEY = 'm2ddlogger/datadog/http_endpoint/api_key';
    const CONFIG_DD_HTTP_INTAKE_URLS = 'm2ddlogger/datadog/http_endpoint/intake_url';
