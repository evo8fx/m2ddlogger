...
{
    const CONFIG_ENABLED = 'm2ddlogger/event_log/file/enabled';
    const CONFIG_LOG_FILE_PATH = 'm2ddlogger/event_log/file/log_file_path';
    const CONFIG_DEV_MODE_ENABLE = 'm2ddlogger/event_log/file/enabled_in_developer_mode';
    const CONFIG_ACCEPTABLE_LEVEL = 'm2ddlogger/event_log/file/acceptable_level';
